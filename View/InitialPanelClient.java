...
public class InitialPanelClient extends JPanel {

    private CenterPanelClient cp;
    private AddPanelClient apc;

    public InitialPanelClient() {
        super();
        cp = new CenterPanelClient();
        add(cp);
        apc = new AddPanelClient();
        add(apc);
    }

    public CenterPanelClient getCp() {
        return cp;
    }

    public void setCp(CenterPanelClient cp) {
        this.cp = cp;
    }

    public void setApc(AddPanelClient apc) {
        this.apc = apc;
    }

    public AddPanelClient getApc() {
        return apc;
    }
}
